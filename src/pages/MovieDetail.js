...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=084215fd59db0dd690d1e60b411b3b1d`);
  ...
  return (
    <main>
      <section className="flex justify-around flex-wrap py-6">
        ...
        <div className="max-w-2xl text-gray-700 text-left text-lg dark:text-white p-2">
